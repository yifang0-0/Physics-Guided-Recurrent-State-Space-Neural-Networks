...
def get_dataset_options(dataset_name):
    if dataset_name == 'cascaded_tank':
        ...
        dataset_parser.add_argument('--seq_len_train', type=int, default=128)
        dataset_parser.add_argument('--seq_len_test', type=int, default=1024)
        dataset_parser.add_argument('--seq_len_val', type=int, default=128)
        dataset_parser.add_argument('--dt', type=float, default=4)
        dataset_parser.add_argument('--k_max_train', type=int, default=128)
        dataset_parser.add_argument('--k_max_test', type=int, default=1024)
        dataset_parser.add_argument('--k_max_val', type=int, default=128)
        ...
        dataset_parser.add_argument('--y_dim', type=int, default=1)
        dataset_parser.add_argument('--u_dim', type=int, default=2)
        ...
        dataset_parser.add_argument('--if_level2', type=int, default=0)
...
def get_model_options(model_type, dataset_name, dataset_options):
    ...
    if dataset_name == 'cascaded_tank':
        ...
        model_parser.add_argument('--h_dim', type=int, default=50)
        model_parser.add_argument('--z_dim', type=int, default=5)
